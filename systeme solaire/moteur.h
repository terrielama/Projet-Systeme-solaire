...
#  endif
  ...
  extern void     rotation(float * m, float angle, float x, float y, float z);
  ...
  extern surface_t * mkDisk(int longitudes, int latitudes);
  extern surface_t * mkOrbite(int longitudes, int latitudes);
